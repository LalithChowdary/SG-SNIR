...
To evaluate scalability, we generate three directed Erd\H{o}s--R\'enyi synthetic networks of increasing size: ER-Small ($n=1000$, $p=0.004$), ER-Medium ($n=3000$, $p=0.0013$), and ER-Large ($n=5000$, $p=0.0008$). The edge probability in each case is set to $p = 4/n$, maintaining a constant expected average degree of 4 across all three networks, consistent with the density of the HIV Transmission dataset.
